...
def get_train_val_loaders(config, mode="train"):
    ...
    if dataset == "cifar10":
        ...
        train_data = CIFAR10Dataset(
            root='../../Dataset/CIFAR10/cifar-10-batches-py', train=True, download=False, transform=train_transform
        )
        test_data = CIFAR10Dataset(
            root='../../Dataset/CIFAR10/cifar-10-batches-py', train=False, download=False, transform=valid_transform
        )
